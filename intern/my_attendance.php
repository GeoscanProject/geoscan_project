      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex justify-content-end mb-3">
            <button id="refreshTable" class="btn btn-success me-md-2"><i class='bx bx-loader' style="color:#fff;"></i>
              &nbsp;Reload</button>
          </div>
            ...
            data.forEach(log => {
              ...
              row.innerHTML = `
                        ...
                        <td>
                          ${log.pin
                  ? (log.photo !== 'N/A'
                    ? `<img src="../uploads/${log.photo}" alt="Photo" width="50" height="50" style="object-fit: cover; cursor: pointer;" onclick="openModal('${log.photo}')">`
                    : 'N/A')
                  : 'Fingerprint used'
                }
                        </td>
