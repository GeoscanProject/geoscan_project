...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $companyEmail = isset($_POST['company_email']) ? $_POST['company_email'] : null;
    $companyAddress = isset($_POST['company_address']) ? $_POST['company_address'] : null;
    $companyContact = isset($_POST['company_contact']) ? $_POST['company_contact'] : null;
    ...
    $sql = 'UPDATE tbl_companies SET company_name = :company_name, email = :company_email, address = :company_address, contactno = :company_contactno WHERE company_id = :company_id';
    $stmt = $pdo->prepare($sql);

    // Bind parameters
    $stmt->bindParam(':company_id', $companyId, PDO::PARAM_INT);
    $stmt->bindParam(':company_name', $companyName, PDO::PARAM_STR);
    $stmt->bindParam(':company_email', $companyEmail, PDO::PARAM_STR);
    $stmt->bindParam(':company_address', $companyAddress, PDO::PARAM_STR);
    $stmt->bindParam(':company_contactno', $companyContact, PDO::PARAM_STR);
