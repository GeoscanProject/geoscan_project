$(document).ready(function () {
    ...
    function fetchCompanyDetails(companyIdToUpdate) {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          $("#edit_company_contactno").val(data.contactno);
        },
    ...
    $("#saveChangesBtn").click(function () {
      ...
      var companyEmail = $("#edit_company_email").val();
      var companyAddress = $("#edit_company_address").val();
      var companyContact = $("#edit_company_contactno").val();
